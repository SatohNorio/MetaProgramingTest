...
{
	/// <summary>
	/// TriggerAction クラス を自動生成するアルゴリズムを定義します。
	/// </summary>
	class TriggerActionCodeStrategy:ICodeStrategy
	{
		/// <summary>
		/// コードの自動生成処理を行います。
		/// </summary>
		...
		private string WriteCommandPropertyBlock(string[] args)
		{
			...
			sb.Append("\r\n");
			sb.Append("    /// <summary>\r\n");
			sb.Append("    /// トリガが実行された時に行う処理を定義します。\r\n");
			sb.Append("    /// </summary>\r\n");
			sb.Append("    /// <param name=\"parameter\">アクションに渡すパラメータを指定します。</param>\r\n");
			sb.Append("    protected override void Invoke(object parameter)\r\n");
			sb.Append("    {\r\n");
			sb.Append("    }\r\n");
			sb.Append("}\r\n");
			sb.Append("\r\n");
